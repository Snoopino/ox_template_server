...
-- Add compatibility with fivem-appearance and fivem-appearance TriggerEvents
RegisterNetEvent('fivem-appearance:loadSkin')
AddEventHandler('fivem-appearance:loadSkin', function(skin, cb)
...
RegisterNetEvent('fivem-appearance:openSaveableMenu')
AddEventHandler('fivem-appearance:openSaveableMenu', function(submitCb, cancelCb)
	local config = {
		ped = true,
		headBlend = true,
		faceFeatures = true,
