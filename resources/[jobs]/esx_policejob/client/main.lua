...
function setUniform(uniform, playerPed)
	TriggerEvent('fivem-appearance:getSkin', function(skin)
		local uniformObject
		...
		if uniformObject then
			TriggerEvent('fivem-appearance:loadClothes', skin, uniformObject)
...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'citizen_wear' then
			if Config.EnableCustomPeds then
				ESX.TriggerServerCallback('fivem-appearance:getPlayerSkin', function(skin, jobSkin)
					local isMale = skin.sex == 0

					TriggerEvent('fivem-appearance:loadDefaultModel', isMale, function()
