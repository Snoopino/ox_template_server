...
CREATE TABLE IF NOT EXISTS `multicharacter_slots` (
  ...
  CONSTRAINT `FK_multicharacter_slots_users` FOREIGN KEY (`identifier`) REFERENCES `users` (`identifier`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping data for table oxtemplate.npwd_twitter_profiles: ~0 rows (approximately)
/*!40000 ALTER TABLE `npwd_twitter_profiles` DISABLE KEYS */;
INSERT INTO `npwd_twitter_profiles` (`id`, `profile_name`, `identifier`, `avatar_url`, `bio`, `location`, `job`, `createdAt`, `updatedAt`) VALUES
	(14, 'Fleevo_Test', 'char1:24dd8c3c6c54660acbde0db8a16e7f323c2c18f4', 'https://i.file.glass/QrEvq.png', NULL, NULL, NULL, '2022-02-13 00:40:12', '2022-02-13 00:40:12');
...
CREATE TABLE IF NOT EXISTS `owned_vehicles` (
  ...
  PRIMARY KEY (`plate`),
  KEY `owner` (`owner`),
  CONSTRAINT `FK_owned_vehicles_users` FOREIGN KEY (`owner`) REFERENCES `users` (`identifier`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `rented_vehicles` (
  ...
  `owner` varchar(46) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`plate`),
  KEY `FK_rented_vehicles_users` (`owner`),
  CONSTRAINT `FK_rented_vehicles_users` FOREIGN KEY (`owner`) REFERENCES `users` (`identifier`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `society_moneywash` (
  ...
  `amount` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_society_moneywash_users` (`identifier`),
  CONSTRAINT `FK_society_moneywash_users` FOREIGN KEY (`identifier`) REFERENCES `users` (`identifier`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping data for table oxtemplate.users: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `user_licenses` (
  ...
  PRIMARY KEY (`id`),
  KEY `owner` (`owner`),
  CONSTRAINT `FK_user_licenses_users` FOREIGN KEY (`owner`) REFERENCES `users` (`identifier`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table oxtemplate.user_licenses: ~0 rows (approximately)
